            ...
            <div className="w-full lg:w-2/3">
              <>
                <div className="rounded-lg">
                  <div className="flex font-bold justify-center items-center lg:justify-start mb-2 border-b px-4 pb-4 pt-3 ">
                    <img
                    ...
                    />
                    <div>
                      <h4 className="text-md font-bold">{savingPlan?.title}</h4>
                      <span
                  ...
                  <ul className="mb-0 list-none">
                    ...
                    <li className="flex justify-between px-4 pb-4">
                      <div className="flex font-bold gap-2 text-lg">Total</div>
                      <span className="text-lg font-bold">
